# Note to reader: This script uses a ".2" subsample fraction instead of the .65 
# mentioned in the writeup to speed up testing. See the "lab3.out" file for example
# output.
## Load Packages
library("doParallel")
library('foreach')
